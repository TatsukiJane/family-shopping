...
export class GithubError extends Error {
  ...
  /**
   * Координаты не сходятся: нет такого репозитория, ветки или пути. Отдельно
   * от 401/403 — лечится правкой настроек, а не заменой токена.
   *
   * На чтении файла 404 до сюда не доходит: getFile возвращает null, это
   * штатный сигнал «список ещё не создан».
   */
